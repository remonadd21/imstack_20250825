...
class MobileNote8 extends MobileNote7{
	...
	public MobileNote8(String face) { super(); this.face = face; super.setIris(getIris());}
	...
	@Override
	public String toString() {
		return "MobileNote8 [face=" + face + "]";
	}
	

	void newShow() {
		super.newShow(); // 상속받은 note7에서 가져옴
		System.out.println("Note8의 기능"
				+ "\tFace: "+this.face);
...
class MobileNote9 extends MobileNote8{   
	...
	void newShow() {
		super.newShow(); // 상속받은 note8에서 가져옴 
		System.out.println("Note9의 기능"
...
//      my9.newShow();
      ...
      MobileNote9 my9re = new MobileNote9();
      my9re.setIris("red");
      my9re.setFace("cat");
      my9re.setBattery(24);
      my9re.newShow();
      // 노트7의 face는  null
      // 노트9는 상속 받은 8을 가장 우선시 함
