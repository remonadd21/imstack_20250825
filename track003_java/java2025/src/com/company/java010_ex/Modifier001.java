...
import com.company.java010.ToyBox;

// 자체문제
// Q1. 아래 클래스 public 으로 접근할 수 있게 만들기
// Q2. java010 폴더에 toyBox class 만들기
/*
class ToyBox{
...
public class Modifier001 extends ToyBox {
	public static void main (String[] args) {
      ToyBox box = new ToyBox();
      System.out.println(box.sharedToy);	
      // System.out.println(box.secretToy); private이라 접근하기 어려움
      //System.out.println(box.familyToy);	// 같은 package 안에서만 가능함
